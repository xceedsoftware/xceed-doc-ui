...
A LayoutAnchorableFloatingWindow or a `LayoutDocumentFloatingWindow` is created automatically when the end-user drags an anchorable over the DockingManager.
